                    ...
                    for (int y = -radius; y <= radius; y++)
                    {
                        ...
                        if (Math.Sqrt(x * x + y * y) <= radius + 0.5)   //this make so the explosion radius is a circle
                        {
                            ...
                            else
                            {
                                ...
                                if (Main.rand.Next(20) == 1) Projectile.NewProjectile(position.X + x, position.Y + y, Main.rand.Next(20) - 10, Main.rand.Next(20) - 10, mod.ProjectileType("ClusterBombChildProjectile"), 120, 20, projectile.owner, 0.0f, 0);
